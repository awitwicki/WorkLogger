        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractStartedDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    VacationDaysPerYear = table.Column<int>(type: "int", nullable: false),
                    IsRequiredToFill = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("77701216-174e-47aa-9ee5-1dcee619317e"), null, "user", "USER" },
                    { new Guid("995592d3-42fd-46d3-ba46-7ffee9c05481"), null, "moderator", "MODERATOR" },
                    { new Guid("9abadff5-56de-493c-a608-5f129132b313"), null, "admin", "ADMIN" }
                });
